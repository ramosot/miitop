<?php
class SoporteBDPlugIn implements iApplicationUIExtension
{
	...
	public function OnDisplayRelations($oObject, WebPage $oPage, $bEditMode = false)
	{
		...
		{
			$aTargetClasses = MetaModel::GetModuleSetting('pdvsa-sbd-integration', 'target_classes', array());
			...
			if ($bIsTarget)
			{
				...
				{
					$oPage->SetCurrentTab(Dict::S('UI:SoporteBDTab'));
					$sUrl = MetaModel::GetModuleSetting('pdvsa-sbd-integration', 'sbd_url', '');
